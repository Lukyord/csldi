...
jQuery(document).ready(function ($) {
    ...
    $(".modal-form").on("submit", function (e) {
        ...
        $modal.find(".modal-ttl h2").text("Thank you");
        $modal
            .find(".modal-desc p")
            .text(
                "Thank you for submitting your works. We will get back to you as soon as possible. Looking forward to working with you."
            );
    });
});
...
jQuery(document).ready(function ($) {
    ...
    if ($(".swiper.auto").length) {
        $(".swiper.auto").each(function () {
            ...
            const autoPlayInterval = $this.data("autoplay-interval");
            const autoPlayDelay = $this.data("autoplay-delay") || 0;

            const initialSlide = $this.data("initial-slide");
            ...
            const swiper = new Swiper($this[0], {
                ...
                on: {
                    init: function () {
                        ...
                        // Add ellipsis class if more than 5 slides
                        if (
                            slideTotal > 5 &&
                            this.pagination &&
                            this.pagination.el
                        ) {
                            this.pagination.el.classList.add("ellipsis");
                        }
                    },
                },
            });
...
jQuery(document).ready(function ($) {
    ...
    $(".modal-form").on("submit", function (e) {
        ...
        $modalContent.find(".modal-ttl h2").text("Thank you");
        $modalContent
            .find(".modal-desc p")
            .text(
                "Thank you for submitting your works. We will get back to you as soon as possible. Looking forward to working with you."
        ...
        if (!isSmallScreen) {
            ...
            $modalContent.css("grid-gap", "var(--spacing-3xl)");
        }
    });
});
